...
export default function Chats() {
  return (
    ...
    <div className='rounded-circle row-1 justify-content-center' style={{width:'65px', height:'65px', backgroundImage:'url(https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHBlb3BsZXxlbnwwfHwwfHx8MA%3D%3D)' ,backgroundSize: 'cover',
    ...
    <div className='border light-green-bg rounded-5 p-3 mx-2 mt-2' style={{width:'35vw',minHeight:'10vh',fontSize:'18px', position:'absolute',right:'0px'}}>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Culpa quae, placeat iste dolor exercitationem recusandae facilis deserunt veritatis odit saepe? Consequatur vel minima tempora! Blanditiis nam, doloribus omnis temporibus sint maxime ab optio, accusantium voluptates nesciunt animi obcaecati nostrum cupiditate aut saepe nihil corporis. Quas id necessitatibus fugiat dignissimos reprehenderit.
        </div>
